    ...
    module Hive
      ...
      def self.hive_query?
        @@rate_limit.within_bounds?(
          KEY_TOTAL,
          threshold: ::Observatory::Config::RateLimiting::Hive::TOTAL_THRESHOLD,
          interval:  ::Observatory::Config::RateLimiting::Hive::TOTAL_INTERVAL
        )
      end
      ...
      def self.get_player_data?(type: )
        ...
        if type == :user
          ...
          @@rate_limit.within_bounds?(
            ...
            threshold: Observatory::Config::RateLimiting::Hive::USER_THRESHOLD,
            interval:  Observatory::Config::RateLimiting::Hive::USER_INTERVAL
          )
        elsif type == :background
          @@rate_limit.within_bounds?(
            KEY_GET_PLAYER_DATA_BACKGROUND,
            threshold: Observatory::Config::RateLimiting::Hive::BACKGROUND_THRESHOLD,
            interval:  Observatory::Config::RateLimiting::Hive::BACKGROUND_INTERVAL
          )
        else
